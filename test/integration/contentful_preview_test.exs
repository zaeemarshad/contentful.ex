defmodule Contentful.PreviewTest do
  ...
  test "entries" do
    ...
    use_cassette "entries" do
      assert {:ok, entries} = Preview.entries(@space_id, @access_token)
  ...
  test "search entry with includes" do
    ...
    use_cassette "single_entry_with_includes" do
      ...
      assert {:ok, entries} =
               Preview.entries(space_id, @access_token, %{
  ...
  test "entry" do
    ...
    use_cassette "entry" do
      assert {:ok, entry} = Preview.entry(@space_id, @access_token, "5JQ715oDQW68k8EiEuKOk8")
  ...
  test "content_types" do
    ...
    use_cassette "content_types" do
      assert {:ok, types} = Preview.content_types(@space_id, @access_token)
  ...
  test "content_type" do
    ...
    use_cassette "content_type" do
      assert {:ok, content_type} =
               Preview.content_type(@space_id, @access_token, "1kUEViTN4EmGiEaaeC6ouY")
  ...
  test "assets" do
    ...
    use_cassette "assets" do
      assert {:ok, assets} = Preview.assets(@space_id, @access_token)
  ...
  test "asset" do
    ...
    use_cassette "asset" do
      assert {:ok, asset} = Preview.asset(@space_id, @access_token, "2ReMHJhXoAcy4AyamgsgwQ")
      fields = asset["fields"]
  ...
  test "space" do
    ...
    use_cassette "space" do
      assert {:ok, space} = Preview.space(@space_id, @access_token)
